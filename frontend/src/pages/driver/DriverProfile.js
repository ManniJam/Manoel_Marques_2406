...
import { User, Mail, Phone, Star, Car, Award, Settings, Bell, Shield } from 'lucide-react';
                ...
                <div className="bg-gray-100 inline-block px-4 py-2 rounded-lg">
                  <div className="flex items-center text-sm">
                    ...
                    <span className="font-medium">
                      {user.vehicle.color} {user.vehicle.make} {user.vehicle.model} • {user.vehicle.plate}
                    </span>
                  </div>
                </div>
              )}
        ...
        {user?.vehicle && (
          <Card className="p-6 mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <div className="text-sm text-gray-500 mb-1">Make & Model</div>
              ...
              <div>
                ...
                <div className="font-semibold text-lg">{user.vehicle.year}</div>
              </div>
              <div>
                <div className="text-sm text-gray-500 mb-1">Color</div>
                <div className="font-semibold text-lg">{user.vehicle.color}</div>
              </div>
              <div>
                <div className="text-sm text-gray-500 mb-1">License Plate</div>
                <div className="font-semibold text-lg">{user.vehicle.plate}</div>
              </div>
            </div>
          </Card>
        )}
          ...
          <div className="space-y-3">
            ...
            <button className="w-full text-left p-4 rounded-xl hover:bg-gray-50 transition-colors flex items-center">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-600">Emergency contacts and safety settings</div>
              </div>
            </button>
            <button className="w-full text-left p-4 rounded-xl hover:bg-gray-50 transition-colors flex items-center">
